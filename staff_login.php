...
<style>
  ...
  <h3 style="color:white; padding-left: 30px;"><i>TEACHER LOGIN</i></h3>
     ...
     <div class="col-sm-offset-4 col-sm-4" style="margin-top: 50px;">
	            <div class="panel panel-primary">
	            	<div class="panel-heading">
                            <center>
                                <img src="staff_login.jpg" alt="alt" height="50%" width="50%"/>
                            </center>
	            	</div>
	            	<div class="panel-body">
                            <form method="POST" action="staff_login_submit.php">
